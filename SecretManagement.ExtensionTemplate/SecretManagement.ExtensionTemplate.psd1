@{
	...
	# RequiredAssemblies = @('bin\SecretManagement.ExtensionTemplate.dll')

	# Type files (.ps1xml) to be loaded when importing this module
	# TypesToProcess = @('xml\SecretManagement.ExtensionTemplate.Types.ps1xml')

	# Format files (.ps1xml) to be loaded when importing this module
	# FormatsToProcess = @('xml\SecretManagement.ExtensionTemplate.Format.ps1xml')
